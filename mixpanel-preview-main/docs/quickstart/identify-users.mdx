...
All of our sample code transparently retries and backoff from rate limit exceptions. If you require a higher-limit for a 1-time backfill, please reach out to us at [apis@mixpanel.com](/docs/quickstart/).
</Tab>


</Tabs>

<Icon icon="party-horn" iconType="solid" /> Congratulations, you’ve tracked your first user! You can see them in Mixpanel via the [Users page](https://mixpanel.com/report/users).
...
<CardGroup>
  <Card title="Track Events in Your Product" icon="clipboard-list" iconType="solid" href="#" horizontal/>
</CardGroup>
