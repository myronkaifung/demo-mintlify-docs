---
title: Rate Limits
description: "We enforce a rate limit on our API to ensure the integrity of our system as well as prevent a single project from monopolizing the available resources for other projects. Getting a 429 response code from our API means that you have reached our rate-limit."
---
...
- Consolidate multiple queries into a single query (for example, multiple queries
