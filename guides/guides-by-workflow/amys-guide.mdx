...
sidebarTitle: "Explore Data with AI"
tag: "New"
---
...
<iframe src="https://www.youtube.com/embed/NQygWnSViZc" title="YouTube video player" frameborder="0" className="w-full aspect-video rounded-xl" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />
...
- <Badge color="green" shape="pill" stroke>hello</Badge>

<Steps>
  <Step title="Single Query">
    Ask basic questions.
  </Step>
  <Step title="Multi-Query Analysis">
    Chain multiple questions.
  </Step>
  <Step title="Cross-Source Joins">
    Connect Mixpanel to other data sources.
  </Step>
  <Step title="Automated Delivery" iconType="thin">
    Set up recurring reports.
  </Step>
  <Step title="Embedded in Decision">
    It's always there.
  </Step>
</Steps>
...
![Mcp Notion](/images/mcp-notion.gif)
