...
Autocapture is available on all plans. Autocapture is currently available for web only via Mixpanel's [Javascript SDK](https://docs.mixpanel.com/docs/tracking-methods/sdks/javascript). To turn it on, ensure you have the config `{autocapture: true}` set in the SDK.
...
By default, Mixpanel considers a click on an interactive element to be a dead click if there are no responses within 0.5 seconds. You can configure these qualifying criteria to something that best suits your application by overriding the defaults in the [Javascript SDK](https://docs.mixpanel.com/docs/tracking-methods/sdks/javascript).
...
By default, Mixpanel considers 4 clicks within a second and between 30 pixels apart as a rage click. You can configure these qualifying criteria to something that best suits your application by overriding the defaults in the [Javascript SDK](https://docs.mixpanel.com/docs/tracking-methods/sdks/javascript).
