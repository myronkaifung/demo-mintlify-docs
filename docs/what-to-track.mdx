...
description: "In this guide, we provide guidance on what to track and how to track it. TESTING"
---
...
Link to [GDPR compliance](https://mixpanel-edb78807.mintlify.app/docs/privacy/gdpr-compliance#right-to-access-and-data-portability) (full URL)

Link to [GDPR](/docs/privacy/gdpr-compliance) (select file)
