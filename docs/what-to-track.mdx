...
<CardGroup>
  <Card icon="users" iconType="solid" horizontal title="Social">
    Post Created, Friend Added
  </Card>
  <Card icon="cart-shopping" horizontal title="E-Commerce">
    Purchase Completed, Review Submitted
  </Card>
  <Card icon="play" horizontal title="Media">
    Video Watched, Article Read
  </Card>
  <Card icon="cloud" horizontal title="SaaS">
...
<CardGroup>
  <Card icon="rocket" iconType="solid" horizontal href="/docs/quickstart/install-mixpanel" title="Start Quickstart Guide">
