...
<CardGroup>
  <Card icon="clipboard-list" iconType="solid" horizontal href="/docs/what-to-track" title="Planning Your Tracked Events">
...
<CardGroup>
  <Card icon="download" iconType="solid" horizontal href="/docs/quickstart/install-mixpanel" title="Install Mixpanel">
